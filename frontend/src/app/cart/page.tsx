...
export default function CartPage() {
  ...
  // thêm trạng thái sản phẩm được chọn
  ...
  // chỉ tính tiền sản phẩm được chọn
  const subtotal = (Array.isArray(cart) ? cart : [])
    .filter(
      (item) => item.asin && selectedItems.includes(item.asin)
    )
    .reduce(
            ...
            {cart.map((item, index) => (
              ...
              >
                ...
                <input
                  ...
                  onChange={() => item.asin && toggleSelect(item.asin)}
                ...
                <div className="flex-1">
                  ...
                  <p className="text-red-600 font-extrabold mt-1">
                  ...
                  <div className="flex items-center gap-3 mt-3">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
                      ...
                      <button
                        onClick={() => item.asin && updateQuantity(item.asin, -1)}
                ...
                <button
                  ...
                  onClick={() => item.asin && removeFromCart(item.asin)}
